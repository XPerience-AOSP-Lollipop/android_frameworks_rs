...
$(ll_bc_files): $(intermediates)/%.bc: $(LOCAL_PATH)/%.ll $(AOSP_LLVM_AS)
	@mkdir -p $(dir $@)
	$(hide) $(RELATIVE_PWD) $(AOSP_LLVM_AS) $< -o $@
...
$(LOCAL_BUILT_MODULE): $(AOSP_LLVM_LINK)
$(LOCAL_BUILT_MODULE): $(AOSP_LLVM_AS) $(BCC_STRIP_ATTR)
	...
	$(hide) $(RELATIVE_PWD) $(AOSP_LLVM_LINK) $(PRIVATE_BC_FILES) -o $@.unstripped 2> >(grep -v "\(modules of different\)\|^$$" >&2)
